...
import com.example.meloch.databinding.DialogPocketMoneyBinding

class PocketMoneyDialogFragment(
    private val currentAmount: Double = 0.0,
    private val onAmountSaved: (Double) -> Unit
) : DialogFragment() {

    private var _binding: DialogPocketMoneyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogPocketMoneyBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        const val TAG = "PocketMoneyDialogFragment"
    }
}
